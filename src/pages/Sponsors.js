  ...
  return (
    <div className={`${styles.colorit}`}>
      <div className={`relative ${styles.colorit}`}>
        ...
        <h1 className="font-text font-bold absolute bottom-4 text-center w-full d-flex text-xl sm:bottom-16 md:text-4xl lg:bottom-32 text-white">Title Sponsor</h1>
      </div>
      <br />
