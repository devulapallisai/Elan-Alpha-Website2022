    ...
    <div className="Events  bg-events text-white" >
      ...
      <h1 className="font-heading text-white text-4xl md:text-6xl text-center pt-11">
        ...
        <div className={`container mx-auto grid md:grid-cols-11 mt-10`}>
            ...
            <Card type='col-span-3 mx-0' text="To be announced......" button={true} image={Zakir} buttonText="PROSHOWS" />
            <img src={line} alt="imagehere" className='my-auto mx-auto col-span-1 hidden md:block' ></img>




            <Card type='col-span-3 mx-0' text="To be announced......" button={true} image={Zakir} buttonText="INFORMAL EVENTS" />
            <img src={line} alt="imagehere" className='my-auto mx-auto col-span-1 hidden md:block' ></img>




            <Card type='col-span-3 mx-0' text="To be announced......" button={true} image={Zakir} buttonText="WORKSHOPS" />
        ...
        <div className="md:hidden overflow-hidden mx-10">
          <div className="grid grid-cols-1 mx-auto">
            <Card type='col-span-3 mx-0' text="To be announced......" button={true} image={Zakir} buttonText="PROSHOW" />
          </div>
